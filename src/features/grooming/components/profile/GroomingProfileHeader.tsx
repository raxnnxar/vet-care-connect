...
const GroomingProfileHeader = () => {
  ...
  React.useEffect(() => {
    const fetchProfileData = async () => {
      ...
      // Fetch profile image from pet_grooming table
      ...
      if (groomingError) {
        console.error('Error fetching grooming profile image:', groomingError);
      } else if (groomingData?.profile_image_url) {
        setProfileImage(groomingData.profile_image_url);
      }
...
export default GroomingProfileHeader;
