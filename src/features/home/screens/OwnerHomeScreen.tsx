        ...
        <div className="px-4 -mt-4 relative z-10 mb-3">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 relative">
            <input 
              ...
              className="w-full px-4 py-3 pl-12 bg-white rounded-xl focus:outline-none focus:ring-2 focus:ring-[#91CFC2] focus:border-transparent text-gray-700 placeholder-gray-500" 
            />
