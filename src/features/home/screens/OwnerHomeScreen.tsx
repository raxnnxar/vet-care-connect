      ...
      <div className="flex flex-col min-h-full bg-[#F9FAFB]">
        ...
        <div className="px-4 -mt-4 relative z-10 mb-3">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 relative">
            <input type="text" placeholder="Buscar servicios veterinarios..." className="w-full px-4 py-3 pl-12 bg-white rounded-xl focus:outline-none focus:ring-2 focus:ring-[#91CFC2] focus:border-transparent text-gray-700 placeholder-gray-500" />
        ...
        <div className="px-4 pb-20 space-y-2.5">
          {/* Full width - Salud */}
          <button onClick={handleSaludClick} className="w-full bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-20 py-[54px]">
          ...
          <div className="flex gap-2.5">
            <button onClick={handleEsteticaClick} className="flex-1 bg-white rounded-2xl p-3 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-24 py-[54px]">
              <div className="flex flex-col items-center justify-center h-full text-center">
                <div className="bg-[#91CFC2] w-10 h-10 rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow mb-2">
                  <Scissors className="w-5 h-5 text-white py-[0px] my-[65px]" />
                </div>
                <h3 className="font-semibold text-gray-800 text-sm">Estética</h3>
              </div>
            </button>
            
            <button onClick={handleCercaDeTiClick} className="flex-1 bg-white rounded-2xl p-3 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-24 py-[54px]">
              <div className="flex flex-col items-center justify-center h-full text-center">
                <div className="bg-[#91CFC2] w-10 h-10 rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow mb-2">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-5 h-5 text-white my-[97px]">
          ...
          <button onClick={handleTratamientosClick} className="w-full bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-20 py-[54px]">
            <div className="flex items-center justify-between h-full">
              <div className="flex items-center space-x-4">
                <div className="bg-[#91CFC2] w-12 h-12 rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow">
