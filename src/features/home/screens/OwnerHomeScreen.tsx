  ...
  return <LayoutBase header={<div className="flex justify-between items-center px-4 py-3 bg-[#79d0b8]">
      ...
      <div className="flex flex-col min-h-full bg-[#F9FAFB]">
        ...
        <div className="px-4 pb-20 space-y-2.5">
          {/* Full width - Salud */}
          <button onClick={() => {}} className="w-full bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-20 py-[55px]">
          ...
          <div className="flex gap-2.5">
            <button onClick={() => {}} className="flex-1 bg-white rounded-2xl p-3 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-24 py-[55px]">
            ...
            <button onClick={() => {}} className="flex-1 bg-white rounded-2xl p-3 border border-gray-100 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 text-left group hover:scale-[1.01] active:scale-[0.99] h-24 py-[55px]">
              <div className="flex flex-col items-center justify-center h-full text-center py-[4px]">
                <div className="bg-[#91CFC2] w-10 h-10 rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow mb-2">
