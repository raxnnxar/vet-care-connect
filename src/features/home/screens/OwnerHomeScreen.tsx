  ...
  return <LayoutBase header={<div className="flex justify-between items-center px-4 py-3 bg-[#79d0b8]">
      ...
      <div className="flex flex-col gap-6 p-4 pb-20">
        ...
        <div className="relative">
          <input type="text" placeholder="Buscar servicios veterinarios..." className="w-full px-4 py-2 pl-10 bg-white/80 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#5FBFB3] focus:border-transparent" />
