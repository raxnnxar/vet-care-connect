...
const SettingItem: React.FC<{
  ...
  return <Button variant="ghost" className="w-full flex items-center justify-between p-3 h-auto" onClick={onClick}>
  ...
  return <LayoutBase header={<div className="flex justify-between items-center px-4 py-3 bg-[#79d0b8]">
      ...
      <div className="p-4 pb-20 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="divide-y">
            <SettingItem icon={<Bell className="h-5 w-5 text-[#5FBFB3]" />} title="Notificaciones push" rightElement={<Switch defaultChecked />} />
            <SettingItem icon={<Bell className="h-5 w-5 text-[#5FBFB3]" />} title="Recordatorios de citas" rightElement={<Switch defaultChecked />} />
          </div>
        </div>
