...
const VetLocationSetupScreen: React.FC = () => {
  ...
  const handleFinishSetup = async () => {
    ...
    if (!address.trim()) {
      toast.error('Por favor ingresa la dirección del consultorio');
      return;
    }
    ...
    try {
      ...
      toast.success('Ubicación del consultorio guardada correctamente');
      navigate(ROUTES.VET);
    } catch (error: any) {
      ...
      <div className="container mx-auto max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">
            Establece la ubicación donde atenderás a tus pacientes
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-500">
              Esta información es esencial para que los dueños de mascota puedan encontrarte fácilmente y sepan dónde se llevará a cabo cada cita.
            </p>
          </div>
...
export default VetLocationSetupScreen;
