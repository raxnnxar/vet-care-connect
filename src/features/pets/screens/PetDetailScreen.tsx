    ...
    const fetchPet = async () => {
      ...
      try {
        ...
        const {
          data,
          error: fetchError
        } = await supabase.from('pets').select('*').eq('id', id).maybeSingle();
        if (fetchError) {
          throw fetchError;
        }
        if (data) {
      ...
      <div className="mobile-container mobile-padding vett-content-safe mobile-spacing">
        ...
        <div className="relative">
          {pet.profile_picture_url ? <div className="h-64 rounded-xl overflow-hidden shadow-lg">
              <img src={pet.profile_picture_url} alt={pet.name} className="w-full h-full object-cover" />
            </div> : <div className="h-64 bg-gradient-to-br from-[#79D0B8] to-[#5FBFB3] rounded-xl flex items-center justify-center shadow-lg mx-[0px] my-[0px]">
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            {pet.sex && <div className="text-center">
            ...
            {pet.temperament && <div className="text-center">
          ...
          {petDescription !== 'Sin descripción adicional' && <div className="mt-6 pt-6 border-t border-gray-100">
        ...
        <Card className="p-4">
          <Button variant="outline" className="w-full border-[#79D0B8] text-[#79D0B8] hover:bg-[#79D0B8]/10 h-12" onClick={handleViewMedicalInfo}>
